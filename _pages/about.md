...
---
<img src="/assets/images/about/LinkedInPFP.jpg" alt="Abdullah Khaled headshot" style="width: 15vw; height: 15vw; float:left; padding: 10px; border-radius: 20px" loading="lazy" decoding="async">
...
<img src="/assets/images/about/ProjectTaleem.jpg" alt="Project Taleem volunteers with students at Ma'ruf Dallas" style="width: 25vw; height: auto; float:right; padding: 10px; border-radius: 20px" loading="lazy" decoding="async">
<br>
...
{% include videotextbreak %}
<img src="/assets/images/about/itkansenatorsquare.jpg" alt="FIRST robotics demo for Senator Chris Van Hollen with ITKAN team" style="width: 20vw; height: auto; float:left; padding: 10px; border-radius: 20px" loading="lazy" decoding="async">
<br>
